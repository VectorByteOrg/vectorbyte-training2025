...
plot(as.vector(phen$observation), xlab="month", ylab="pheno", type="l", xlim=c(0, 1560),
...
```
Pretty good! Let's fit one more model then we'll talk about out of sample comparisons...
